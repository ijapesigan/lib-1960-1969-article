...
[![Non-ASCII
Check](https://github.com/ijapesigan/lib-1960-1969-article/actions/workflows/non-ascii-check.yml/badge.svg)](https://github.com/ijapesigan/lib-1960-1969-article/actions/workflows/non-ascii-check.yml)
...
<div id="ref-Hamilton-1960" class="csl-entry">

Hamilton, M. (1960). A rating scale for depression. *Journal of
Neurology, Neurosurgery & Psychiatry*, *23*(1), 56–62.
